...
import org.isf.medicalstock.gui.DateTextField;
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (correctDate) {
                    ...
                    MovBrowserManager movBrowserManager = new MovBrowserManager();
					...
					switch(selectedIndex){
						case 0:
							...
							pMovements = movBrowserManager.getMovementForPrint(medical,
